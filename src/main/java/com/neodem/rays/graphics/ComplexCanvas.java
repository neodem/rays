 ...
 */
public abstract class ComplexCanvas extends ActiveCanvas implements Runnable, KeyListener {

    private static final Logger logger = LoggerFactory.getLogger(ComplexCanvas.class);
    ...
    public ComplexCanvas(Dimension canvasSize) {
        super(canvasSize); // we don't use the default JPanel double-buffering
            ...
            if (paintThread == null) {
                ...
                paintThread = new Thread() {
                    public void run() {
                        while (true)
                            try {
                                ComplexCanvas.this.paint(ComplexCanvas.this.getGraphics());
